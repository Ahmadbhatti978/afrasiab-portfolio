        ...
        <div className="grid md:grid-cols-2 gap-6">
          {projects.map((project, i) => (
            <motion.div
              ...
              className="glass-card p-6 group hover:border-glow transition-all duration-500 hover:glow-box cursor-default"
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <ExternalLink className="w-4 h-4 text-muted-foreground/40 group-hover:text-primary transition-colors mt-1" />
              </div>
